...
public class ChatRoomDetailsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.superwechar.R.layout.em_activity_chatroom_details);
		instance = this;
		st = getResources().getString(cn.ucai.superwechar.R.string.people);
		loadingPB = (ProgressBar) findViewById(cn.ucai.superwechar.R.id.progressBar);

		TextView chatRoomIdTextView = (TextView) findViewById(cn.ucai.superwechar.R.id.tv_chat_room_id_value);
		TextView chatRoomNickTextView = (TextView) findViewById(cn.ucai.superwechar.R.id.tv_chat_room_nick_value);
        ...
        RelativeLayout changeChatRoomNameLayout = (RelativeLayout) findViewById(cn.ucai.superwechar.R.id.rl_change_chatroom_name);
        RelativeLayout changeChatRoomDescriptionLayout = (RelativeLayout) findViewById(cn.ucai.superwechar.R.id.rl_change_chatroom_detail);
		...
		ownerAdminAdapter = new OwnerAdminAdapter(this, cn.ucai.superwechar.R.layout.em_grid_owner, ownerAdminList);
		EaseExpandGridView ownerAdminGridView = (EaseExpandGridView) findViewById(cn.ucai.superwechar.R.id.owner_and_administrators);
		...
		membersAdapter = new MemberAdapter(this, cn.ucai.superwechar.R.layout.em_grid_owner, memberMuteBlockList);
		EaseExpandGridView userGridView = (EaseExpandGridView) findViewById(cn.ucai.superwechar.R.id.gridview);
	...
	protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
		...
		String st1 = getResources().getString(cn.ucai.superwechar.R.string.being_added);
		String st2 = getResources().getString(cn.ucai.superwechar.R.string.is_quit_the_chat_room);
		String st3 = getResources().getString(cn.ucai.superwechar.R.string.chatting_is_dissolution);
		String st4 = getResources().getString(cn.ucai.superwechar.R.string.are_empty_group_of_news);
		String st5 = getResources().getString(cn.ucai.superwechar.R.string.is_modify_the_group_name);
		final String st6 = getResources().getString(cn.ucai.superwechar.R.string.Modify_the_group_name_successful);
		final String st7 = getResources().getString(cn.ucai.superwechar.R.string.change_the_group_name_failed_please);
		String st8 = getResources().getString(cn.ucai.superwechar.R.string.Are_moving_to_blacklist);
		final String st9 = getResources().getString(cn.ucai.superwechar.R.string.failed_to_move_into);

		final String stsuccess = getResources().getString(cn.ucai.superwechar.R.string.Move_into_blacklist_success);
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							runOnUiThread(new Runnable() {
								@Override
								public void run() {
									TextView tv = (TextView) findViewById(cn.ucai.superwechar.R.id.tv_chat_room_nick_value);
	...
	public void clearGroupHistory() {
		...
		Toast.makeText(this, cn.ucai.superwechar.R.string.messages_are_empty, Toast.LENGTH_SHORT).show();
	}
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
                            ...
                            TextView chatRoomTitle = (TextView) findViewById(cn.ucai.superwechar.R.id.tv_chatroom_name);
							...
							Button destroyButton = (Button)ChatRoomDetailsActivity.this.findViewById(cn.ucai.superwechar.R.id.btn_destroy_chatroom);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case cn.ucai.superwechar.R.id.clear_all_history: // clear conversation history
				String st9 = getResources().getString(cn.ucai.superwechar.R.string.sure_to_empty_this);
				...
				break;
			case cn.ucai.superwechar.R.id.rl_change_chatroom_name:
				...
				break;
			case cn.ucai.superwechar.R.id.rl_change_chatroom_detail:
    ...
    private final int[] ids = {
            cn.ucai.superwechar.R.id.menu_item_transfer_owner,
            cn.ucai.superwechar.R.id.menu_item_add_admin,
            cn.ucai.superwechar.R.id.menu_item_rm_admin,
            cn.ucai.superwechar.R.id.menu_item_remove_member,
            cn.ucai.superwechar.R.id.menu_item_add_to_blacklist,
            cn.ucai.superwechar.R.id.menu_item_remove_from_blacklist,
            cn.ucai.superwechar.R.id.menu_item_mute,
            cn.ucai.superwechar.R.id.menu_item_unmute
    };
    ...
    private class OwnerAdminAdapter extends ArrayAdapter<String> {
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			if (convertView == null) {
				...
				holder.imageView = (ImageView) convertView.findViewById(cn.ucai.superwechar.R.id.iv_avatar);
				holder.textView = (TextView) convertView.findViewById(cn.ucai.superwechar.R.id.tv_name);
				holder.badgeDeleteView = (ImageView) convertView.findViewById(cn.ucai.superwechar.R.id.badge_delete);
				convertView.setTag(holder);
			} else {
				holder = (ViewHolder) convertView.getTag();
			}
			final LinearLayout button = (LinearLayout) convertView.findViewById(cn.ucai.superwechar.R.id.button_avatar);
			// group member item
			...
			LinearLayout id_background = (LinearLayout) convertView.findViewById(cn.ucai.superwechar.R.id.l_bg_id);
			id_background.setBackgroundColor(convertView.getResources().getColor(
					position == 0 ? cn.ucai.superwechar.R.color.holo_red_light: cn.ucai.superwechar.R.color.holo_orange_light));
	...
	Dialog createMemberMenuDialog() {
		...
		dialog.setContentView(cn.ucai.superwechar.R.layout.em_chatroom_member_menu);

		int ids[] = { cn.ucai.superwechar.R.id.menu_item_add_admin,
				cn.ucai.superwechar.R.id.menu_item_rm_admin,
                cn.ucai.superwechar.R.id.menu_item_remove_member,
				cn.ucai.superwechar.R.id.menu_item_add_to_blacklist,
				cn.ucai.superwechar.R.id.menu_item_remove_from_blacklist,
							...
							try {
								switch (v.getId()) {
									...
									case cn.ucai.superwechar.R.id.menu_item_mute:
										...
										break;
									case cn.ucai.superwechar.R.id.menu_item_unmute:
										List<String> list = new ArrayList<String>();
										list.add(operationUserId);
										EMClient.getInstance().chatroomManager().unMuteChatRoomMembers(roomId, list);
										break;
									case cn.ucai.superwechar.R.id.menu_item_transfer_owner:
	...
	private class MemberAdapter extends ArrayAdapter<String> {
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			if (isInMuteList(username)) {
				id_background.setBackgroundColor(convertView.getResources().getColor(cn.ucai.superwechar.R.color.gray_normal));
			} else if (isInBlackList(username)) {
				id_background.setBackgroundColor(convertView.getResources().getColor(cn.ucai.superwechar.R.color.holo_black));
			} else {
				id_background.setBackgroundColor(convertView.getResources().getColor(cn.ucai.superwechar.R.color.holo_blue_bright));
			}
	...
	public void onDestroyChatRoomClick(View v) {
        startActivityForResult(new Intent(this, ExitGroupDialog.class).putExtra("deleteToast", getString(cn.ucai.superwechar.R.string.dissolution_group_hint)),
