...
public class EaseContactAdapter extends ArrayAdapter<User> implements SectionIndexer{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            if(res == 0)
                convertView = layoutInflater.inflate(cn.ucai.easeui.R.layout.ease_row_contact, parent, false);
            else
                convertView = layoutInflater.inflate(res, null);
            holder.avatar = (ImageView) convertView.findViewById(cn.ucai.easeui.R.id.avatar);
            holder.nameView = (TextView) convertView.findViewById(cn.ucai.easeui.R.id.name);
            holder.headerView = (TextView) convertView.findViewById(cn.ucai.easeui.R.id.header);
    ...
    public Object[] getSections() {
        ...
        list.add(getContext().getString(cn.ucai.easeui.R.string.search_header));
        ...
        protected synchronized FilterResults performFiltering(CharSequence prefix) {
            ...
            if(prefix==null || prefix.length()==0){
                ...
                for(int i=0;i<count;i++){
                    ...
                    if(usernick.contains(prefixString)||username.contains(prefixString)){
                        newValues.add(user);
                    }
                    else{
//                         final String[] words = username.split(" ");
                         final String[] words = usernick.split(" ");
